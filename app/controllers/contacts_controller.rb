class ContactsController < ApplicationController
  ...
  before_action :set_option_for_select, only: [ :new, :edit, :update, :create]
  http_basic_authenticate_with name: "enchenu", password: "123", only: :destroy
  ...
  private
    ...
    def contact_params
      ...
      adrress_attributes: [:street, :city, :state],
